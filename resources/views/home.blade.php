...
@section('content')
    <section id="ez-body__center-content" class="col-lg-8 mt-3">
        <div class="search-bar row" style="margin: 5px">
            <input type="text" class="col-md-10" onkeyup="homeSearchSubmit()" id="home-search" placeholder="Search" />
            <div class="col-md-2">
                <select  id="search_type" style="height: 6vh;border: none;border-radius: 10px" class="browser-default custom-select mb-4" name="type">
                    <option value="" disabled selected hidden>search filter by :</option>
                            ...
                            <form action="{{route('posts.store')}}" method="POST" class="container" id="add-post-form" enctype="multipart/form-data">
                               ...
                               @csrf
                                ...
                                <div class="post-category d-flex justify-content-between align-items-center m-auto w-75">
                                    ...
                                    <select class="js-example-basic-multiple" id="post-category" name="category_id">
                        ...
                        @foreach($expected_users as $user)
                            <div class="people mt-2">
                                <a href="{{route('profile',$user->id)}}">
                                    ...
                                    <a id="expected-friend-btn-{{$user->id}}" onclick="addFriendSubmit({{$user->id}},'expected')" class="btn btn-warning text-white">add friend</a>
                            ...
                            <div class="group">
                                <a href="{{route('main-group',$group->id)}}">
                                    ...
                                    <div class="mt-2 group-info">
                                        <div>
                                            <p><b>{{$group->name}}</b></p>
                                            <p id="members-{{$group->id}}">{{$group->members}} members</p>
                                        </div>
                            ...
                            <div class="group">
                                <a href="{{route('main-page',$page->id)}}">
                                    ...
                                    <div class="mt-2 group-info">
                                        <div>
                                            <p><b>{{$page->name}}</b></p>
                                            <p id="page-members-{{$page->id}}">{{$page->members}} likes</p>
                                        </div>
