    ...
    <div class="row">
        ...
        <div class="col-md-4 my-2">
            <div class="group-img-container">
                <img src="{{asset('media')}}/{{$image}}" alt="" class="group-img img-fluid pointer" data-toggle="modal" data-target="#images{{$image}}">
            </div>
        </div>
        @endforeach
    </div>
        ...
        <div class="modal-content" style="background: rgba(0,0,0,0);border: none">
          <div class="modal-body" >
              <div class="group-img-container text-center post-modal">
                <img  src="{{asset('media')}}/{{$imagemodel}}" alt="" class="group-img img-fluid " ><br>
