...
use App\Models\Inspiration;use App\Models\UserHoppy;use App\Models\UserMusic;use App\Models\UserSport;
...
@section('content')
    ...
    <section id="ez-body__center-content-music" class="col-lg-10 row profile-center-content">
        <div class="col-lg-12 profile-center-content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <input type="text" class="search-box" placeholder="Search about your hobby" id="search" onkeyup="myFunction()">
                        ...
                        @if($myProfile == 1)
                            <div class="group-mygroups py-3">
                                ...
                                <div class="row text-center totyAdmin">
                                    <button onclick="showAllMusics()" class=" button-4 col-5 mx-auto tablinks" href="">All Hobbies</button>
                                    <button onclick="showMyMusics()" class="button-4 col-5  mx-auto tablinks" href="">My Hobbies</button>
                                </div><br>

                                <div id="all-musics" class=" tabcontent" >
                                    <div  class="row ">
                                        @foreach($hoppies['allHoppies'] as $oneAllMusic)
                                            <div class="music col-sm-3 target">
                                                <form action="{{route('redeny.user.list.hoppy')}}" method="post" style="display:inline;">
                                                    @csrf
                                                    <img src="{{asset('assets/images/hoppies/'.$oneAllMusic->image)}}" alt="" style="height:250px;width: 100%">
                                ...
                                <div style="display:none;" id="my-musics" class=" tabcontent" >
                                    <div  class="row ">
                                        @foreach($hoppies['myHoppies'] as $oneAllMusic)
                                            <div class="music col-sm-3 target">
                                                <form action="{{route('redeny.user.list.hoppy')}}" method="post" style="display:inline;">
                                                    @csrf
                                                    <img src="{{asset('assets/images/hoppies/'.$oneAllMusic->music->image)}}" alt="" style="height:250px;width: 100%">
                                        ...
                                        @foreach($hoppies['myHoppies'] as $oneAllMusic)
                                            <div class="music col-sm-3 target">
                                                <form action="{{route('redeny.user.list.hoppy')}}" method="post" style="display:inline;">
                                                    ...
                                                    <center>
                                                        <?php
                                                        $inMyCokkection = UserHoppy::where('userId',auth::user()->id)->where('hoppieId',$oneAllMusic->music->id)->get();
                                                        ?>
                                                        <h2>
