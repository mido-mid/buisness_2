    ...
    public function getHomePosts(Request $request){
        ...
        if($this->valid_token == 0) {
            ...
            return response()->json([
                ...
                //'expected_groups', 'expected_pages', 'expected_posts', 'privacy', 'categories', 'times', 'ages', 'reaches', 'reacts', 'friends_info', 'cities', 'countries', 'another_comments'
            ]);

        }
    }
    private function getPosts($user, $user_follows, $friends_posts, $user_pages, $user_groups, $user_posts, $user_sponsored_posts)
    {
        ...
        //$follows_posts, $auth_user_posts , $friends_posts
        //$posts = array_merge($pages_posts,$follows_posts, $auth_user_posts, $friends_posts, $groups_posts, $user_sponsored_posts);
        $posts = array_merge($pages_posts, $groups_posts, $user_sponsored_posts);
        shuffle($posts);
